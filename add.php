...
<body>
    ...
    <div id="wrapper">
        <header class="tech-header header">
            <div class="container-fluid">
                <nav class="navbar navbar-toggleable-md navbar-inverse fixed-top bg-inverse" style="background: brown !important;">
                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                        <div class="page-wrapper">
                            <div class="blog-title-area text-center">
                                ...
                                <span class="color-orange"><select name="" id="">
                                ...
                                <h3><input type="text" class="form-control" style="text-align:center;font-weight:bold"></h3>
                            ...
                            <div class="single-post-media">
                                <img src="upload/tech_menu_08.jpg" alt="" class="img-fluid" id="imgtlt">
                                <input type="file" name="" id="imgtitle" style="display:none" accept="image/png, image/gif, image/jpeg">
                            </div><!-- end media -->

                            <div class="blog-content fr-view">  
                            <div id="example"></div>
                            <button onclick="yess()">Show</button>
    ...
    <script>
        let editor = new FroalaEditor('#example', {}, function () {
    // setInterval(function () {console.log(editor.html.get())}, 1000);
    console.log(editor.html.get())
        ...
        function subm()
        {
            ...
            console.log(editor.html.get())
            var A = document.getElementById('example').getElementsByTagName('img')
  ...
  document.getElementById('example').parentElement.innerHTML =  editor.html.get()
            
        }

        function imgtitles()
        {
            document.getElementById('imgtitle').click()
        }

        imgtitle.onchange = evt => {
        const [file] = imgtitle.files
        if (file) {
            imgtlt.src = URL.createObjectURL(file)
        }
        }

        window.onload = function()
        {
            document.getElementById('fr-logo').innerHTML = ''
            console.log(document.getElementById('imgtlt').addEventListener('click',imgtitles))
